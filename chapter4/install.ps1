...
# 定义文件路径
$chapterPath = Join-Path -Path $GamePath -ChildPath "chapter4_windows"
...
$patchFile = Join-Path -Path $ScriptDir -ChildPath "resources\chapter4.xdelta"
$chapterResourcesPath = Join-Path -Path $ScriptDir -ChildPath "resources\chapter4_windows"
